...
<body id="bg">
	...
	<div class="container">
		...
		<div class="leftsidebar_box">
			<a href="/admin/home " target="main"><div class="line">
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="../img/coin111.png" /><img class="coin22"
						src="../img/coin222.png" /><a class="cks" href="/admin/user"
			...
			<dl class="system_log">
				<dt>
					<img class="icon1" src="../img/coin03.png" /><img class="icon2"
						src="../img/coin04.png" /> 关于我们<img class="icon3"
						src="../img/coin19.png" /><img class="icon4"
						src="../img/coin20.png" />
				</dt>
				<dd>
			...
			<dl class="system_log">
				...
				<dd>
                    ...
                    <img class="coin22" src="../img/coin222.png" /><a class="cks" href="/admin/department" target="main">科室管理</a><img class="icon5" src="../img/coin21.png" />
                </dd>
				<dd>
					<img class="coin11" src="../img/coin111.png" /><img class="coin22"
