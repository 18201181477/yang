		...
		<div class="container">
			...
			<div class="top-nav cl-effect-5">
				...
				<ul class="nav1">
					...
					<li><a href="<?php echo e(URL::route('index/about')); ?>" class="<?php echo e(Request::getPathInfo()=='/about' ? 'active':''); ?>"> <span data-hover="医疗常识">医疗常识</span></a></li>
			...
			<form action="<?php echo e(url('service')); ?>" class="navbar-form navbar-right">
				<!-- <div class="btn-group">
				    ...
				    <?php echo e(Session::get('address')); ?> <span class="caret"></span>
				    </span>
