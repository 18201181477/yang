				...
				<div class="conform">
					<form>
						<div class="cfD">
							...
							<a href="<?php echo e(url('admin/member')); ?>" style="text-align:center;display:block;width:100px;" class="userbtn">添加</a>
					...
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<?php foreach($data['data'] as $val){?>
							<tr height="40px">
								...
								<td><img src="/img/<?php echo e($val['img']); ?>" style="height: 100px;width: 200px;" /></td>
								<td><?php echo $val['per_url']?></td>
								<td><?php echo $val['per_info']?></td>
								<td><?php echo date('Y-m-d H:i:s',$val['add_time'])?></td>
								<td><a href="<?php echo e(url('admin/memberSave')); ?>?id=<?php echo $val['id']?>" id="up"><img class="operation"
...
<script>
	$('.del').click(function(){
		...
		$.ajax({
			type:'get',
			url:"<?php echo e(url('admin/memberDel')); ?>",
			data:'id='+id,
			success:function(e) {
				if(e==1) {
