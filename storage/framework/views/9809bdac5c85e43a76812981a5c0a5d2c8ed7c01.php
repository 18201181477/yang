...
<body>
  <div id="pageAll">
    ...
    <div class="page">
      ...
      <div class="vip">
        <div class="conform">
          <form action="<?php echo e(url('admin/title')); ?>" method="get">
            <div class="cfD">
              时间段：<input class="vinput mh_date" type="text" readonly="true" />&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
              <input class="vinput mh_date" type="text" readonly="true" />
            </div>
            <div class="cfD">
              <input value="<?php echo e(isset($_GET['name']) ? $_GET['name'] : ''); ?>" class="addUser" name="name" type="text" placeholder="输入作者" />
          ...
          <table border="1" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td><div class="onsImg onsImgv">
                  <img src="/img/<?php echo e($v->title_img); ?>">
                </div></td>
              <td><?php echo e($v->title_author); ?></td>
              <td><?php echo e($v->title_name); ?></td>
              <td><?php echo e($v->sort); ?></td>
              <td><span><?php echo e($v->zan); ?></span><input id="num" class="vipinput" type="text"><a data-id="<?php echo e($v->id); ?>" class="vsAdd" javascript:;>增加</a></td>
...
<script type="text/javascript">
  $(".vsAdd").click(function(){
    ...
    $.ajax({
      type:'get',
      url:"<?php echo e(url('admin/ajax/title')); ?>",
      data:{'num':num,'id':id},
