				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="435px" class="tdColor">权限</td>
							<td width="130px" class="tdColor">操作</td>
						</tr>
						<?php foreach($data as $v): ?>
						<tr height="40px">
							<td><?php echo e($v['rid']); ?></td>
							<td><?php echo e($v['role_name']); ?></td>
							<td>
								<?php foreach($v['menu_name'] as $val): ?>
									<?php echo e($val.','); ?>

								<?php endforeach; ?>
							</td>
							<td><a href="<?php echo e(url('admin/BackRoleSave')); ?>?rid=<?php echo e($v['rid']); ?>"><img class="operation"
									src="img/update.png"></a> <a href="javascript:;" class="del" num="<?php echo $v['rid']?>"><img class="operation delban"
