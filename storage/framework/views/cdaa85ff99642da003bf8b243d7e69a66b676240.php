    ...
    <div class="pageTop">
        <div class="page">
            ...
            <div class="add" style="float:right;display: inline-block;height: 20px;">
                <a class="addA" href="<?php echo e(url('hos/addpage')); ?>" style="color:#fff">添加科室&nbsp;&nbsp;+</a>
            </div>
        </div>
    </div>
    <div class="page">
                    ...
                    <?php if(!empty($v['son'])){
                        ...
                        foreach($v['son'] as $kk => $vv){?>
                            <tr class="son">
                                ...
                                <td>
                                <a href="<?php echo e(url('hos/doctor')); ?>?name=<?php echo $vv['name'] ?>">查看医生</a>
                                </td>
...
<script type="text/javascript">
    ...
    $(document).on('click','.del',function(){
        ...
        if(window.confirm('此操作将删除该科室？')){
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('hos/officesdel')); ?>",
