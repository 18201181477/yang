...
<div id="pageAll">
		...
		<div class="page ">
		<form action="{{url('admin/title')}}" method="post" enctype="multipart/form-data">
		{{csrf_field()}}
			<!-- 上传广告页面样式 -->
			<div class="banneradd bor">
				...
				<div class="baBody">
					...
					<div class="bbD">
						文章内容：<script id="editor" name="title_conntent" type="text/plain" style="width:1024px;height:500px;">{{ old('title_conntent') }}</script>
					</div>
					<div class="bbD">
						文章照片：
						<div class="bbDd">
