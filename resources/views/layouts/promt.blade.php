...
<body>
        ...
        <div class="wrapper-page">
            <div class="panel panel-color {{ \Session::get('status')?'panel-inverse':'panel-danger' }}">
                ...
                <div class="panel-body">
                    <div class="text-center">
                        <div class="alert {{ \Session::get('status')?'alert-info':'alert-danger' }} alert-dismissable">
                        ...
                        <div class="form-group m-b-0">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn"> <button type="submit" class="btn {{ \Session::get('status')?'btn-success':'btn-danger' }}">点击立即跳转</button> </span>
                            </div>
                        </div>
